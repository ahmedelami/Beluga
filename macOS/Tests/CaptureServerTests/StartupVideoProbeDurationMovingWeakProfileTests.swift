...
final class StartupVideoProbeDurationMovingWeakProfileTests: XCTestCase {
    func testBothDurationArmsAcceptOnlyTheFixedMovingWeakProfile() {
    ...
    func testNumericAndOptionalProfileDriftIsRejectedIndependently() {
        ...
        for duration in [15, 40] {
            ...
            for bitrate in [UInt64(0), 1, 799_999, 800_001, 8_000_000, UInt64.max] {
                var input = valid
    ...
    private struct Input {
        ...
        var bitsPerSecond: UInt64 = 800_000
