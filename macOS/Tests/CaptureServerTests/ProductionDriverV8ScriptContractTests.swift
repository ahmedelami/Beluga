    ...
    func testV8CandidatePreparerIsExactVersionedV7Derivation() throws {
        ...
        let expected = v7
            ...
            .replacingOccurrences(
                ...
                with: #"/Volumes/t7/opensteamer-mic-installed-baseline.j8nyo9/source"#
            )
        ...
        XCTAssertTrue(v8.contains(#"$repo" == "/Volumes/t7/opensteamer-mic-installed-baseline.j8nyo9/source""#))
