...
readonly EXPECTED_APP_BASENAME="Beluga Host.app"
...
assert_real_file "$APP_ICON" "Beluga app icon" 644
ICON_SHA256="$(/usr/bin/shasum -a 256 "$APP_ICON" | /usr/bin/awk '{ print $1 }')" || fail \
...
assert_plist_value CFBundleName "Beluga Host"
...
print -u2 -- "Verified Beluga Host bundle: $APP_PATH"
